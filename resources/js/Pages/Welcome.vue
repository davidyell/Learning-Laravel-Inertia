...
<template>
    ...
    <div class="pt-24">
        ...
        >
            <!--Left Col-->
            <div
                class="flex flex-col w-full md:w-2/5 justify-center items-start text-center text-white md:text-left"
            >
                <p class="uppercase tracking-loose w-full">
                    Pet and animal rescue centre
                </p>
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Find your next best friend today!
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    All kinds of pets available from mice to elephants
                </p>
                <button
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            >
                Find your new forever pet
            </h2>
            <div class="w-full mb-4">
                <div
                    class="h-1 mx-auto brand-gradient w-64 opacity-25 my-0 py-0 rounded-t"
                ></div>
            </div>
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    >
                        Browse online and meet face to face
                    </h3>
                    <p class="text-gray-600 mb-8">
                        Browse pets looking for forever homes online to find
                        your new best friend
                    </p>
                    <p class="text-gray-600 mb-8">
                        Visit one of our centres to spend time picking your new
                        pet or book an introduction session
                    </p>
                    <p class="text-gray-600 mb-8">
                        <Link
                            :href="route('pets.index')"
                            class="text-violet-800"
                            >Adopt a pet today!</Link
                        >
                    </p>
                </div>
                <div class="w-full sm:w-1/2 p-6">
                    <img
                        src="/undraw_friends_xscy.svg"
                        alt="Meet your pet with an intro session"
                    />
                </div>
            </div>
        </div>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            Call us to recover animals in need
                        </div>
                        <p class="text-gray-800 text-base px-6 mb-5">
                            We can attend animals in distress or need of
                            emergency care any time day or night.
                        </p>
                    </a>
                </div>
                <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="w-full font-bold text-xl text-gray-800 px-6"
                        >
                            Fully licensed vets and care facilities
                        </div>
                        <p class="text-gray-800 text-base px-6 mb-5">
                            We can help nurse injured or neglected pets back to
                            their former selves with our capable team.
                        </p>
                    </a>
                </div>
                <div
                ...
                >
                    <div class="flex items-center justify-center">
                        <button
                            @click.prevent="router.get(route('page.care'))"
                            class="mx-auto lg:mx-0 hover:underline brand-gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                        >
                            Vetenarian care
                        </button>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            All animals deserve the chance to find a forever
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <button
            @click.prevent="router(route('page.donate'))"
            class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
            Donate today!
        </button>
